...
ALLOWLIST_MISSING_ALT_TEXT = {
    "qiskit_addon_mpf/backends/tenpy_layers/__init__.py": [76, 90],
    "qiskit_addon_mpf/backends/quimb_layers/__init__.py": [69, 83]
}
...
def main() -> None:
    files = glob.glob("qiskit_addon_mpf/**/*.py", recursive=True)
